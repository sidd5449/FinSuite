...
"[project]/src/app/data:9c9475 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$9c9475__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:9c9475 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function DeleteClientDialog({ isOpen, onOpenChange, clientId, clientName, onSuccess }) {
    ...
    const handleDelete = async ()=>{
        setLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$9c9475__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteClientAction"])(clientId);
        if (result.success) {
            toast({
                title: 'Success!',
...
"[project]/src/components/clients/clients-table.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$clients$2f$delete$2d$client$2d$dialog$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/clients/delete-client-dialog.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
//# sourceMappingURL=_a342cbf9._.js.map