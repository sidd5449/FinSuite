...
"[project]/src/app/data:be04b9 [app-ssr] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$be04b9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:be04b9 [app-ssr] (ecmascript) <text/javascript>");
'use client';
;
;
;
...
function DeleteClientDialog({ isOpen, onOpenChange, clientId, clientName, onSuccess }) {
    ...
    const handleDelete = async ()=>{
        setLoading(true);
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$be04b9__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["deleteClientAction"])(clientId);
        if (result.success) {
            toast({
                title: 'Success!',
...
//# sourceMappingURL=_44244130._.js.map