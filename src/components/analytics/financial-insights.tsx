  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Generate insights, predict cash flow, and get financial projections based on your business data.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        {insights && (
          <div className="grid gap-4 md:grid-cols-1 lg:grid-cols-3">
            ...
            <Card>
              <CardHeader>
                <CardTitle className="font-headline text-lg">Cash Flow Prediction</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">{insights.cashFlowPrediction}</p>
              </CardContent>
            </Card>
            <Card>
              <CardHeader>
                <CardTitle className="font-headline text-lg">Financial Projections</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-muted-foreground">{insights.financialProjections}</p>
              </CardContent>
            </Card>
          </div>
        )}
